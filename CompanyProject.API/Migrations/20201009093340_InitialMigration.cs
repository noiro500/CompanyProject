        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreateTime = table.Column<string>(nullable: false, defaultValue: "09.10.2020 0:00"),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 54, new[] { "Диагностика оборудования", "Поиск и установка драйвера устройства", "Подключение и базовая настройка принтера", "Настройка работы принтера по Wi-Fi сети", "Индивидуальная настройка принтера", "Прочие необходимые работы" }, 10, "Настройка принтера", "Принтеры", "1500" },
                    ...
                    { 53, new[] { "Необходимые работы определяются заказчиком" }, 7, "Внеплановый выезд специалиста", "ИТ-услуги для бизнеса", "1000 рублей за внеплановый выезд" },
                    ...
                    { 55, new[] { "Диагностика оборудования", "Чистка и профилактика принтера", "Полная чистка и смазка с частичной разборкой принтера", "Прочие необходимые работы" }, 10, "Очистка принтера", "Принтеры", "2000" },
                    { 56, new[] { "Диагностика оборудования", "Восстановление работоспособности печатающей головки струйного принтера", "Ремонт электроники принтера", "Замена фотоцилиндра, магнитного вала или ракеля лазерного принтера", "Прочие необходимые работы" }, 10, "Ремонт принтера", "Принтеры", "5000" },
                    { 57, new[] { "Поиск и установка драйвера устройства", "Подключение и базовая настройка МФУ", "Калибровка сканирующей части МФУ", "Настройка работы МФУ по Wi-Fi сети", "Настройка работы МФУ по локальной сети", "Индивидуальная настройка МФУ", "Прочие необходимые работы" }, 10, "Настройка МФУ", "Многофункциональное устройство (МФУ)", "2000" },
                    { 58, new[] { "Диагностика оборудования", "Чистка и профилактика МФУ", "Полная чистка и смазка с частичной разборкой МФУ", "Калибровка сканирующей части МФУ", "Прочие необходимые работы" }, 10, "Очистка МФУ", "Многофункциональное устройство (МФУ)", "2500" },
                    { 59, new[] { "Диагностика оборудования", "Восстановление работоспособности печатающей головки струйного МФУ", "Ремонт электроники МФУ", "Замена фотоцилиндра, магнитного вала или ракеля лазерного МФУ", "Ремонт сканирующей части МФУ", "Прочие необходимые работы" }, 10, "Ремонт МФУ", "Многофункциональное устройство (МФУ)", "5500" },
                    ...
                    { 60, new[] { "Диагностика оборудования", "Поиск и установка драйвера устройства", "Подключение и базовая настройка сканера", "Калибровка сканера", "Настройка работы сканера по Wi-Fi сети", "Настройка работы сканера по локальной сети", "Индивидуальная настройка сканера", "Прочие необходимые работы" }, 10, "Настройка сканера", "Сканирующие устройства (сканеры)", "1500" },
                    ...
                    { 61, new[] { "Диагностика оборудования", "Ремонт инвертора лампы подсветки", "Замена лампы подсветки", "Ремонт других электронных узлов сканера", "Ремонт механики сканирующей головки", "Прочие необходимые работы" }, 10, "Ремонт сканера", "Сканирующие устройства (сканеры)", "5000" }
                });
